                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route("faqs.update", $faq->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" name="question" class="form-control form-control-lg" placeholder="Question" value="{{ $faq->question }}" />
                            </div>
                            <div class="form-group">
                                <textarea name="response" id="mytextarea" class="form-control form-control-lg" rows="10" placeholder="Réponse">{{ $faq->response }}</textarea>
                            </div>
