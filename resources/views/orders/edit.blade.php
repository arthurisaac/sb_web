            ...
            <div class="col-md-4 col-lg-4 grid-margin stretch-card">
                <div class="col">
                    <div class="card card-rounded">
                        <div class="card-body">
                            @if($order->Box)
                                <h4>Cadeau: {{ $order->Box->name }}</h4>
                                <h5>Prix: {{ $order->Box->price }}</h5>
                                <br>
                            ...
                            @if($payment)
                                ...
                                @elseif ($payment->confirmation == -1)
                                    <a onclick="if(confirm('Confirmer suppression ?')){document.getElementById('deleteform').submit()}"
                                       class="btn btn-sm btn-danger">Supprimer la commande</a>
                    ...
                    <div class="card card-rounded mt-5">
                        <div class="card-body">
                            <form action="{{ route("reservation-change-box") }}" method="POST" novalidate>
                                @csrf
                                <hr>
                                <h3 class="text-danger">Echanger de cadeau</h3>
                                <br>
                                <label for="box" class="col-form-label">Cadeau</label>
                                <input type="hidden" name="order" value="{{$order->id}}">
                                ...
                                <br>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">Valider l'echange</button>
                                </div>
                            </form>
                        </div>
                    </div>
